...
pub(super) fn message_attribute(source: &str) -> Option<(&'static str, &'static str)> {
    match source {
        ...
        "= {v}" => Some(("inquiry", "v")),
        "A newer SCENG CAD Civil version is published on GitHub." => Some(("ui", "a-newer-open-cad-studio-version-is-published-o")),
        ...
        "Make SCENG CAD Civil your default CAD app?" => Some(("modal", "make-open-cad-studio-your-default-cad-app")),
        ...
        "Open .dwg and .dxf drawings in SCENG CAD Civil by default. You can change this later in your system settings." => Some(("modal", "open-dwg-and-dxf-drawings-in-open-cad-studio-b")),
        "SCENG CAD Civil could not trust the certificate presented for the plugin registry. Check your system certificate and proxy settings, then retry." => Some(("plugins", "open-cad-studio-could-not-trust-the-certificat")),
        "SCENG CAD Civil plugins are native packages and cannot run inside a browser. Download the desktop app to browse, install, and use plugins." => Some(("plugins", "open-cad-studio-plugins-are-native-packages-an")),
        "SCENG CAD Civil ready." => Some(("file", "open-cad-studio-ready")),
        ...
        "Save stopped: \"{file_name}\" changed outside SCENG CAD Civil." => Some(("file", "save-stopped-file-name-changed-outside-open-ca")),
        ...
        "SCENG CAD Civil — 2D/3D CAD editor" => Some(("common", "open-cad-studio-2d-3d-cad-editor")),
        ...
        "Open .dwg and .dxf files with SCENG CAD Civil" => Some(("common", "open-dwg-and-dxf-files-with-open-cad-studio")),
        ...
        "SCENG CAD Civil Web App" => Some(("common", "open-cad-studio-web-app")),
        ...
        "Launch SCENG CAD Civil" => Some(("common", "launch-open-cad-studio")),
        "SCENG CAD Civil Installer" => Some(("common", "open-cad-studio-installer")),
        "DWG Drawing" => Some(("common", "dwg-drawing")),
        "DXF Drawing" => Some(("common", "dxf-drawing")),
        "Desktop shortcut" => Some(("common", "desktop-shortcut")),
        "Add a shortcut to SCENG CAD Civil on the desktop." => Some(("common", "add-a-shortcut-to-open-cad-studio-on-the-desktop")),
